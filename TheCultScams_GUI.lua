-- <The Cult Scams> Matte UI - v4.9 [SLATE] TS: 11:34:55
...
frame:SetBackdropColor(0.1, 0.2, 0.15, 0.95); frame:Hide()
...
local function Row_OnClick()
    if TheCultScamsDB and TheCultScamsDB.DebugMode then DEFAULT_CHAT_FRAME:AddMessage("|cffaaaaaa[SCAM Debug]|r Clicked: " .. (this.action or "NONE")) end
...
local chatBox = CreateFrame("EditBox", nil, frame, "InputBoxTemplate"); chatBox:SetWidth(200); chatBox:SetHeight(20); chatBox:SetPoint("BOTTOMLEFT", 15, 35); chatBox:SetAutoFocus(false); chatBox:SetScript("OnEnterPressed", function() TheCultScamsCore:SendGroupMessage(currentGroup, this:GetText()); this:SetText(""); this:ClearFocus() end); local footer = frame:CreateFontString(nil, "OVERLAY", "GameFontDisableSmall"); footer:SetPoint("BOTTOM", 0, 10); footer:SetText("The Cult Scams v4.9 [SLATE] TS: 11:34:55"); footer:SetTextColor(0.5, 0.5, 0.5); local cardClose = CreateFrame("Button", nil, card, "UIPanelCloseButton"); cardClose:SetPoint("TOPRIGHT", -2, -2)